...
const ENCRYPTION_KEY = process.env.API_KEY_ENCRYPTION_KEY || DEFAULT_KEY

// Security: Reject the default encryption key in production
if (process.env.NODE_ENV === 'production' && ENCRYPTION_KEY === DEFAULT_KEY) {
